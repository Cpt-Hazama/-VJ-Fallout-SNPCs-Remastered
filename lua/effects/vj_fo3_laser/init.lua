function EFFECT:Init(data)
	...
	util.ParticleTracerEx("vj_f3r_laser_red", self.StartPos, self.EndPos, false, self.ModelEnt:EntIndex(), self.Attachment)
	...
	timer.Simple(self.HitTime,function()
		ParticleEffect("vj_f3r_laser_red_impact",pos,Angle(0,0,0),nil)
	end)
end
