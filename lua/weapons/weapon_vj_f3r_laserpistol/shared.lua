...
---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.WorldModel					= "models/fallout/weapons/w_laserpistol.mdl"
SWEP.PrintName					= "AEP7 Laser Pistol"
SWEP.HoldType 					= "1hp"
...
SWEP.Primary.Sound				= {"vj_fallout/weapons/laserpistol/pistollaser_fire_2d.wav"}
SWEP.Primary.DistantSound		= {"vj_fallout/weapons/laserpistol/pistollaser_fire_3d.wav"}
