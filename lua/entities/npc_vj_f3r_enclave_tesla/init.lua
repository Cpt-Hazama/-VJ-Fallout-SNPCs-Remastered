...
-----------------------------------------------*/
ENT.Model = {"models/fallout/player/tesleakpowerarmor.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want 
ENT.StartHealth = 125

ENT.VJ_NPC_Class = {"CLASS_ENCLAVE"} -- NPCs with the same class with be allied to each other

ENT.FlinchChance = 25 -- Chance of it flinching from 1 to x | 1 will make it always flinch

ENT.SpawnWithApparelChance = 1
ENT.tbl_ApparelModels = {"models/fallout/headgear/tesleakhelm.mdl"}
---------------------------------------------------------------------------------------------------------------------------------------------
