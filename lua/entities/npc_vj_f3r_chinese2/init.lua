...
-----------------------------------------------*/
ENT.Model = {"models/fallout/player/stealthsuitmkii.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want 
ENT.StartHealth = 75
...
function ENT:CustomInit()
	...
	self:SetModel(self.Gender == 1 && "models/fallout/player/stealthsuitmkii.mdl" or "models/fallout/player/female/stealthsuitmkii.mdl")
