...
if SERVER then
    util.AddNetworkString("VJ.F3R.ProjOverlay.Plasma")
else
    local mat = Material("effects/plasma_particle")
    net.Receive("VJ.F3R.ProjOverlay.Plasma", function(len, ply)
        ...
        local hookID = "VJ.F3R.ProjOverlay.Plasma" .. math.Rand(1,999999999)
